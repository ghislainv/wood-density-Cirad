...
Data (including the Cirad wood density database) and R script associated to the present study are available on GitHub: https://github.com/ghislainv/wood-density-Cirad. The repository will be archived with a DOI on the Cirad Dataverse (https://dataverse.cirad.fr) as soon as the article is accepted. This will allow an entirely reproducible and transparent research and a public and permanent access to the Cirad wood density database for future research.
