...
We have answered the Editorial Office comments and formatted the manuscript following AJB formatting guidelines.
...
bioRxiv will usually automatically add a link to the published version within two-three weeks of journal publication (see https://www.biorxiv.org/about-biorxiv). We will contact them to add the DOI link to the publication in _American Journal of Botany_ as soon as possible.
...
We have provided the LaTex source file necessary to compile the manuscript. We also have provided a PDF version of the manuscript.
...
We have modified the manuscript to follow AJB formatting guidelines.
...
We have added a sentence in the Ackowledgments section.
...
We have uploaded all the figures as separated PDF files.
...
We now provide the Supporting Information following the requested format.